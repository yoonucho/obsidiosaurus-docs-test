  ...
  async onload() {
    ...
    const ribbonIconEl = this.addRibbonIcon("file-up", "Obsidiosaurus", async (evt) => {
      try {
        ...
        const basePath = import_path.default.dirname(this.app.vault.adapter.basePath);
...
var SettingTab = class extends import_obsidian2.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian2.Setting(containerEl).setName("Obsidian Directory").setDesc("Path to your obsidian vault").addText((text) => text.setPlaceholder("Enter path").setValue(this.plugin.settings.obsidianVaultDirectory).onChange(async (value) => {
